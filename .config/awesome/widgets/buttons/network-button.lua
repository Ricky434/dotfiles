...
--FUNZIONE BOTTONE MIA
network_button:connect_signal(
	"button::press",
	function (_,_,_,button)
		awful.spawn.single_instance("networkmanager_dmenu -config ~/.config/polybar/shapes/scripts/rofi/networkmenu.rasi")
	end
)
