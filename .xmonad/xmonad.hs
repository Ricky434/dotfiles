...
myFocusColor :: String
myFocusColor  = "#7460BF"  -- Border color of focused windows
...
myKeys =
    ...
    -- Other Prompts
        ...
        , ("M-p u", mkUnicodePrompt "xsel" ["-b"] "/home/jelly/.xmonad/UnicodeData.txt" emojiXPConfig) -- unicodePrompt (for copying emojis)
    ...
    -- Sublayouts [LI HO DISATTIVATI PERCHE' DISATTIVANO I BORDI NON SO COME]
    ...
    -- Keyboard
        , ("M-M1-<Space>", spawn ("setxkbmap us intl"))
        , ("M-C-<Space>", spawn ("setxkbmap us"))
        ]
